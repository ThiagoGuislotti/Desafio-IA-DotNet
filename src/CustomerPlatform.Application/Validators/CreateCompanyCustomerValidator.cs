...
{
    /// <summary>
    /// Validacoes simples para criacao de cliente pessoa juridica.
    /// </summary>
    public sealed class CreateCompanyCustomerValidator : IValidator<CreateCompanyCustomerCommand>
    {
        #region Constants
        private const int NameMinLength = 2;
        private const int NameMaxLength = 200;
        private const int DocumentMinLength = 14;
        ...
        public ValidationResult Validate(CreateCompanyCustomerCommand instance)
        {
            if (instance is null)
            ...
            ValidateRequired(instance.Cnpj, "Cnpj", DocumentMinLength, DocumentMaxLength, errors);
