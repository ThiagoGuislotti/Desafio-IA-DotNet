...
{
    /// <summary>
    /// Evento publicado quando um cliente e atualizado.
    /// </summary>
    public sealed class ClienteAtualizado : IDomainEvent
    {
        #region Constants
        /// <summary>
        /// Nome do evento.
        /// </summary>
        public const string EventTypeName = "ClienteAtualizado";
        #endregion
