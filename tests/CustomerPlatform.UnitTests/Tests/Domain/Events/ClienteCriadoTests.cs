...
{
    [Trait("Category", "Unit")]
    public sealed class ClienteCriadoTests
    {
        #region Variables
        ...
        public ClienteCriadoTests(ITestOutputHelper output)
        {
            _output = output;
        }
        #endregion
        ...
        public void Constructor_DadosValidos_DeveCriarEvento()
        {
            ...
            Assert.Equal(ClienteCriado.EventTypeName, evento.EventType);
        ...
        public void Constructor_ClienteIdVazio_DeveLancarExcecao()
        {
            ...
            // Act
            var ex = Assert.Throws<RequiredFieldException>(() => new ClienteCriado(
                clienteId,
                TipoCliente.PF,
                TestData.CpfValido,
                TestData.NomeCompleto));
