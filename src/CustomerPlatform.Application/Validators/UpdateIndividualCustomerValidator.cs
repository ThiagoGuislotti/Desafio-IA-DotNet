...
{
    /// <summary>
    /// Validacoes simples para atualizacao de cliente pessoa fisica.
    /// </summary>
    public sealed class UpdateIndividualCustomerValidator : IValidator<UpdateIndividualCustomerCommand>
    {
        #region Constants
        ...
        public ValidationResult Validate(UpdateIndividualCustomerCommand instance)
        {
            if (instance is null)
