        ...
        public Task StartAsync(CancellationToken cancellationToken)
        {
            try
            {
                ...
                _compositeService = new Builder()
                    ...
                    .FromFile(Path.Combine(dockerRoot, "observability", "docker-compose-otel.yaml"))
                    .FromFile(Path.Combine(dockerRoot, "observability", "docker-compose-aspire-dashboard.yaml"))
